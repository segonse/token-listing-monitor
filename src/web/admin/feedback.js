...
const API_TOKEN = 'admin123'; // 简单的API令牌
        ...
        <div class="feedback-item" onclick="showFeedbackDetail(${feedback.id})">
            <div class="feedback-header">
                ...
                <div class="feedback-meta">
                    ...
                    <span class="type-badge">${getTypeText(feedback.type)}</span>
                </div>
            </div>
            <div class="feedback-meta">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 绑定筛选器变化事件
    document.getElementById('status-filter').addEventListener('change', loadFeedbacks);
    document.getElementById('type-filter').addEventListener('change', loadFeedbacks);
